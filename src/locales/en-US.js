export default {
  ...
  emailHelper: {
    ...
    cloudDeleteFailed: 'Failed to delete cloud email',
    cloudDeleteError: 'Error deleting cloud email',
    confirmDeleteLocal: 'Continue to delete local record?',
    deleteAborted: 'Delete operation cancelled',
    ...
    someCloudDeletesFailed: 'Some cloud email deletions failed',
    andMore: 'and {count} more',
    confirmClearLocal: 'Continue to clear local records?',
    clearAllAborted: 'Clear operation cancelled',
    clearAllPartialSuccess: 'Local emails cleared',
