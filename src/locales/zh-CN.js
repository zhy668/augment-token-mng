export default {
  ...
  emailHelper: {
    title: '邮箱助手',
    settings: '设置',
    tokenRequired: '请先配置邮箱服务器并获取Token',
    emailType: '邮箱类型',
    randomEmail: '随机邮箱',
    customEmail: '自定义邮箱',
    customEmailName: '自定义邮箱名',
    customEmailPlaceholder: "输入邮箱名(不含{'@'}域名)",
    createEmailBtn: '创建邮箱',
    creating: '创建中...',
    emailList: '邮箱列表',
    stopMonitor: '停止监控',
    emptyState: '暂无邮箱',
    emptyDescription: '点击上方按钮创建新邮箱',
    copyEmail: '复制邮箱',
    copyPassword: '复制密码',
    copyCode: '复制验证码',
    startMonitor: '开始监控',
    ...
    delete: '删除',
    password: '密码',
    settingsTitle: '邮箱服务器设置',
    serverUrl: '服务器地址',
    serverUrlPlaceholder: '输入邮箱服务器地址',
    adminEmail: '管理员邮箱',
    adminEmailPlaceholder: '输入管理员邮箱',
    adminPassword: '管理员密码',
    adminPasswordPlaceholder: '输入管理员密码',
    cardSettings: '信用卡设置',
    cardBin: '信用卡BIN码',
    cardBinPlaceholder: '输入信用卡BIN码 (6-12位数字)',
    cardBinHint: '用于生成测试信用卡号,默认: 515462002040',
    cardBinRequired: '信用卡BIN码不能少于6位',
    addressSettings: '地址信息设置',
    addressHint: '留空则自动随机生成对应字段',
    country: '国家代码',
    countryPlaceholder: '例如: CN, US',
    countryHint: '2位国家代码,留空默认CN',
    province: '省份',
    provincePlaceholder: '例如: 广东省',
    city: '城市',
    cityPlaceholder: '例如: 深圳',
    street: '街道地址',
    streetPlaceholder: '例如: 中山路100号',
    postalCode: '邮政编码',
    postalCodePlaceholder: '例如: 518000',
    cardSettingsSaved: '信用卡设置已保存',
    save: '保存',
    cancel: '取消',
    emailDomain: '邮箱域名',
    customDomain: '自定义域名',
    ...
    domainDeleted: '域名已删除',
    emailPrefix: '邮箱前缀',
    emailPrefixPlaceholder: '默认: augment',
    saveSettings: '保存设置并获取Token',
    gettingToken: '获取Token中...',
    exportEmails: '导出邮箱列表',
    importEmails: '导入邮箱列表',
    clearAll: '清空所有邮箱',
    currentToken: '当前Token',
    tokenConfigured: 'Token已配置',
    emailContent: '邮件内容',
    from: '发件人',
    subject: '主题',
    date: '日期',
    back: '返回',
    loadingEmails: '加载邮件列表中...',
    noEmails: '暂无邮件',
    loadingEmailContent: '加载邮件内容中...',
    emailCopied: '邮箱地址已复制',
    ...
    deleteAborted: '删除已取消',
    cloudDeleteError: '云端删除出错',
    deleteSuccess: '邮箱删除成功',
    deleteLocalSuccess: '本地邮箱删除成功',
    emailNotFound: '邮箱未找到',
    deleteFailed: '删除失败',
    confirmClearAll: '确定要清空所有邮箱吗?此操作不可恢复!',
    clearAllTitle: '清空所有邮箱',
    clearAllMessage: '请选择清空方式:',
    clearLocalOnly: '只清空本地列表',
    clearLocalAndCloud: '清空本地和云端',
    clearingLocalOnly: '正在清空本地邮箱列表...',
    clearingLocalAndCloud: '正在清空本地和云端邮箱...',
    deletingEmails: '正在删除邮箱',
    someCloudDeletesFailed: '部分云端删除失败',
    andMore: '还有 {count} 个',
    confirmClearLocal: '是否继续清空本地列表?',
    clearAllAborted: '清空操作已取消',
    clearAllPartialSuccess: '部分清空成功',
    cloudDeletesFailed: '云端删除失败',
    clearAllSuccess: '所有邮箱已清空',
    clearAllFailed: '清空失败',
    startMonitoringEmail: '开始监控邮箱',
    confirmAutoLogin: '是否自动登录Augment?\n\n选择"确定"将:\n1. 清除登录缓存\n2. 打开登录窗口\n3. 自动填充邮箱\n4. 等待您完成人机验证',
    loginWindowOpened: '登录窗口已打开,请完成人机验证',
    openLoginFailed: '打开登录窗口失败',
    codeFound: '找到验证码',
    settingsSaved: '设置已保存',
    noEmailsToExport: '没有可导出的邮箱',
    exportSuccess: '邮箱列表已导出',
    importSuccess: '成功导入 {count} 个邮箱,跳过 {skipped} 个重复邮箱',
    noEmailsImported: '没有导入任何邮箱',
    importFailed: '导入失败',
    loadEmailsFailed: '加载邮件列表失败',
    quickGetToken: '一键获取Token',
    quickGetTokenHint: '自动登录Augment并获取Token',
    stopQuickGet: '停止获取',
    quickGetStopped: '已停止自动获取',
    startingQuickGet: '正在启动自动获取...',
    waitingForLogin: '请完成登录和人机验证...',
    generatingToken: '正在生成Token...',
    quickRegister: '一键注册',
    quickRegisterHint: '自动填充邮箱和验证码，完成Augment账号注册',
    stopQuickRegister: '停止注册',
    quickRegisterStopped: '已停止自动注册',
    startingQuickRegister: '正在启动自动注册...',
    waitingForRegistration: '请完成人机验证，等待自动注册...',
    registrationCompleted: '注册流程已完成',
    quickRegisterFailed: '自动注册失败',
    tokenSavedSuccess: 'Token已自动保存到列表!',
    tokenSavedSuccessDetail: 'Token获取成功并已保存!',
    tokenObtained: '已获取Token',
    quickGetFailed: '自动获取失败'
  },
  databaseConfig: {
    title: '数据库配置',
    host: '主机地址',
